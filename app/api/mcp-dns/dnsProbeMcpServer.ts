...
import { getDnsTesterMcpSkillResourceProvider } from '@/app/api/mcp/mcpSkillResources'
...
const { manifest, execute } = createMCPHttpServer(MCP_PROBE_INSTALL_SERVER_KEY, MCP_VERSION, MCP_DESCRIPTION, buildDnsProbeMcpToolsMap(), getDnsTesterMcpSkillResourceProvider())
